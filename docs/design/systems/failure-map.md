...
Status: IMPLEMENTED. Sprint 109 wrote the registry, the generator and this map; Sprint 108
authored every board to it; Sprint 110 made routed diagnosis the game's inspection system.
The laws below are executed against the shipped content by
`packages/sim/tests/diagnosisRouteProbes.test.ts`. Amendments to the ontology or laws

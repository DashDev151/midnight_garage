...
*Feature spec, v2 (2026-07-15). Status: IMPLEMENTED across Sprints 73-75, which name it as
their source. `docs/design/systems/failure-map.md` (Sprint 109 onward) carries the ontology forward
and is where diagnosis design now lives. Supersedes v1 (the four-layers

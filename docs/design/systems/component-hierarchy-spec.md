...
*Feature spec, v1 (2026-07-15). Status: IMPLEMENTED across Sprints 70-75: Sprint 70 lays the
parts-provenance groundwork this spec depends on, Sprints 71, 72 and 75 name it as their
source, and Sprint 79 amends its teardown-cost law (that amendment is recorded inline below,
under "deep work is expensive because of the teardown"). Origin: maintainer scoping

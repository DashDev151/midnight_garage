...
Source of truth for Sprints 92 (uniform access) and 93 (band ceiling), SUPERSEDED IN PART by
Sprint 118: the charge model below is no longer how machine hire is billed (see the note
immediately after this paragraph); the capability model still stands. Written after a full
...
> `docs/design/systems/workshop-rework.md`: machine hire is now a DAILY unlock per line (same
...
> is speed + the master contracts, no new perk. See `docs/sprints/sprint_archive/sprint93.md` for the

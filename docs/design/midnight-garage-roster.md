...
| Tier | Count | When |
|---|---|---|
| **PoC** | 10 | Ugly MVP + Vibe Slice (Sprints 4–12) |
| **Go-Live** | ~48 (30 regular + 10 Legends + 8 Gaisha) | v1.0 launch |
| **Eventually** | 80+ | Post-launch expansion packs |

Column key: **P** = PoC-10 · **L** = Go-Live · pack name = post-launch expansion.

---

## Shitboxes (Act 1 service fodder & first flips)
| Car | Engine | Notes | Scope |
|---|---|---|---|
| Honda City E (AA) '84 | ER 1.2 | THE first oil change | **P** |
| Daihatsu Mira (L70) | EB 0.55T | Rusty kei hauler | **L** |
| Toyota Carina (AT150) | 3A-U | Grandpa spec | **L** |
| Nissan Sunny (B12) | GA15 | Fleet white | Eventually |
| Honda Today (JW1) | E05A | Kei Pack |

## Kei Sport & Utility
| Car | Engine | Notes | Scope |
|---|---|---|---|
| Suzuki Wagon R (CT21S) | F6A | Tall-boy icon, service bay regular | **P** |
| Subaru Vivio RX-R (KK3) | EN07X s/c | Safari Rally provenance → magazine event hook | **L** |
| Daihatsu Mira TR-XX Avanzato (L502S) | JB-JL | Kei hot-hatch wars | **L** |
| Suzuki Alto Works (HA21S) | K6A T | Kei hot-hatch wars | **L** |
...
| Car | Engine | Notes | Scope |
|---|---|---|---|
| Honda Civic SiR-II (EG6) | B16A | First proper build | **P** |
| Honda Civic Type R (EK9) | B16B | Kanjo royalty | **L** |
| Honda Integra Type R (DC2) | B18C Spec-R | The FF benchmark | **L** |
| Honda Prelude Si VTEC (BB4) | H22A | Boulevard sophisticate | **L** |
| Honda CR-X SiR (EF8) | B16A | Auto-add | **L** |
| Honda City Turbo II (AA) | ER Turbo | Bulldog; Motocompo trunk-find easter egg | **L** |
| Toyota Starlet Glanza V (EP91) | 4E-FTE | Auto-add | **L** |

## FR / Drift Culture
| Car | Engine | Notes | Scope |
|---|---|---|---|
| Toyota Sprinter Trueno (AE86) | 4A-GE | Obviously | **P** |
| Nissan 180SX (RPS13) | SR20DET | Drift entry | **P** |
| Toyota Chaser Tourer V (JZX90) | 1JZ-GTE | Four-door missile | **P** |
| Nissan Silvia K's (S14) | SR20DET | Buyer favorite | **P** |
| Nissan Silvia (S13) | CA18/SR20 | Drift Pack |
...
| Car | Engine | Notes | Scope |
|---|---|---|---|
| Mazda Savanna RX-7 (FC3S) | 13B-T | The purist's rotary | **P** |
| Mazda RX-7 (FD3S) | 13B-REW | Sequential twin drama | **P** |
| Eunos Cosmo (JC) | 20B-REW | Triple-rotor bubble excess; GPS-nav flavor text | **L** |

## Homologation / AWD Turbo
| Car | Engine | Notes | Scope |
|---|---|---|---|
...
## Flagships, Sleepers & Bubble Weirdos
| Car | Engine | Notes | Scope |
|---|---|---|---|
| Toyota Supra RZ (JZA80) | 2JZ-GTE | The 1000hp Wangan endgame platform | **P** |
| Nissan Fairlady Z (Z32) | VG30DETT | Bubble flagship | **L** |
| Toyota Aristo 3.0V (JZS147) | 2JZ-GTE | Sleeper sedan flip | **L** |
| Autech Stagea 260RS (WGNC34) | RB26DETT | ~1,700-unit RB26 wagon | **L** |
| Toyota Altezza RS200 Z Edition (SXE10) | 3S-GE BEAMS | JDM-only 210PS/6MT the IS300 never got | **L** |
| Honda S2000 (AP1) | F20C | 9k rpm; Rare-tier icon (ex-Legend) | **L** |
| Toyota MR2 (SW20) | 3S-GTE | Snap-oversteer lore | **L** |
| Toyota MR2 (AW11) | 4A-GZE | Eventually |
| Toyota Sera (EXY10) | 5E-FHE | Butterfly doors | **L** |
| Nissan S-Cargo | E15S | The snail. Style-buyer bait | **L** |
| Subaru Alcyone SVX (CXD) | EG33 | Giugiaro glass | Eventually |
| Mitsubishi GTO Twin Turbo (Z16A) | 6G72TT | Eventually |
| Mitsubishi Starion (A187A) | 4G63T | Eventually |
| Toyota Soarer (JZZ30) | 1JZ-GTE | VIP Pack |
...
*Gaisha II Pack:* F355, E36 M3, Escort RS Cosworth, Golf GTI Mk2.

## Era-Progression Wave (2004+ sandbox)

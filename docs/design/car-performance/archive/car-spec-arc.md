> **ARCHIVED.** The opening design of the car spec arc: real stock specs, condition and aftermarket modifiers, and a feel model. Superseded by `docs/design/car-performance/README.md`. Kept as the historical record; do not read it as current.

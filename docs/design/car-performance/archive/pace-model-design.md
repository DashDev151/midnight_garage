> **ARCHIVED.** The design proposal for the timing half of the arc, built on the friction budget. Superseded by `docs/design/car-performance/README.md`. Kept as the historical record; do not read it as current.

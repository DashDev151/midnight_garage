> **ARCHIVED.** The published lateral-g figures gathered for the roster and the structural reasons they cannot be the sim's grip source. Superseded by `docs/design/car-performance/README.md`. Kept as the historical record; do not read it as current.

> **ARCHIVED.** The ten-car pilot research batch that validated the spec schema and the research pipeline before scaling to the roster. Superseded by `docs/design/car-performance/README.md`. Kept as the historical record; do not read it as current.

> **ARCHIVED.** The second, untriaged staging batch of roster spec research. Superseded by `docs/design/car-performance/README.md`. Kept as the historical record; do not read it as current.

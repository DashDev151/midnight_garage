> **ARCHIVED.** The proposed GDD text changes from the Progression Rework arc; the amendment was applied in GDD v0.6. Superseded by `docs/design/midnight-garage-gdd.md`. Kept as the historical record; do not read it as current.
...
> remains a planned but unbuilt staff/player-skill system (see `docs/design/parked/skill-progression.md`

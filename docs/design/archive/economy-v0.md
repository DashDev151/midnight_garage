> **ARCHIVED.** The Sprint 00 draft economy targets, written as hypotheses for the balance harness to test. Superseded by `docs/design/economy-bible.md`. Kept as the historical record; do not read it as current.

> **ARCHIVED.** The equipment-progression spine as designed in 2026-07-09: repair versus replace, with equipment as capability. Superseded by `docs/design/progression-bible.md`. Kept as the historical record; do not read it as current.

# Repair vs. Replace - the equipment progression spine (HISTORICAL)

*Systems design written 2026-07-09 at the maintainer's direction. Supersedes and absorbs the
"equipment-gated repair specialization" TODO note. Status: HISTORICAL. Sprints 12 and 13 built
this model (12 the component-model consolidation, 13 the equipment and repair-vs-replace
economy); the Progression Rework arc (Sprints 36-39) then replaced its equipment-ownership
mechanism with the six tool lines and their tiers. `docs/design/progression-bible.md` is
canonical for progression; this doc records the design that came before it. Companion docs:
`facilities-bays.md` (bays = capacity), `skill-progression.md` (skill = efficiency). This doc
is **equipment = capability**. Together they are the three physical pillars of "Tools, not
levels" (GDD §258).*

 ...
 * ComponentId must never reach player copy directly - this is the one place
 * that maps it to real words, so every screen and every store label goes
 * through it instead of interpolating the id. Seeds the Sprint 26 taxonomy
 * content, which reuses and extends this map for the full 29-part model.
 */

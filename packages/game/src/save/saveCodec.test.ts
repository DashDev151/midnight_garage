...
describe('saveCodec', () => {
   ...
   */
  it('Sprint 39 (techniques + shop title) needed no save bump on its own; SAVE_VERSION has since moved to 36 (Sprint 79)', () => {
    expect(SAVE_VERSION).toBe(36)
  })
   ...
   */
  it('SAVE_VERSION has since moved to 36 (Sprint 79)', () => {
    expect(SAVE_VERSION).toBe(36)
  })
   ...
   * exactly.
   */
  it('SAVE_VERSION is 36 (Sprint 79)', () => {
    expect(SAVE_VERSION).toBe(36)
  })
